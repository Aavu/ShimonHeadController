package ShimonHeadController.innards.provider.network;

import ShimonHeadController.innards.math.linalg.Vec;
import ShimonHeadController.innards.provider.iVectorProvider;
...
public class NetVecProvider implements NetworkGroup.VecHandler, iVectorProvider
{
	...
	static public void main(String[] s)
	{
		...
		{
			/**
			 * @see ShimonHeadController.innards.signal.provider.network.NetworkGroup.VecHandler#handle(String, Vec)
			 */
